...
import MPSChildrenConfig from "@/components/MPSChildrenConfig";
        ...
        <section>
            {plan.mrpComponents.map((component, index) => (
                <div key={index}>
                    ...
                    <MPSChildrenConfig plan={plan} setPlan={setPlan} component={component} handleComponentChange={handleComponentChange} index={index}/>
